...
//**                                                             **
//*****************************************************************
void makeBoundary_impedanceTest_old()
{
     double x_tmp = 0.0;
    double r_tmp = 0.0;
    ...
    i_flx_bl[5][0] = int(x1/dx + 0.5) + 2; //2
    j_flx_bl[5][0] = int(r1/dr + 0.5) + 1; //5
    i_flx_bl[5][1] = int(x2/dx - 0.5) + 1; //21
    j_flx_bl[5][1] = int(r2/dr - 0.5) + 1; //10
    ...
    //=============================================
    //********* Ex境界条件 (左) *********
    for (int j=j_flc_bl[5][0]+1;j<=j_flc_bl[5][1]-1;j++){
        int i=i_flc_bl[5][0]+1;
        iBndWx.push_back(i);
        jBndWx.push_back(j);
        sBndWx.push_back(0); //ディリクレ
...
//**                                                             **
//*****************************************************************
void makeBoundary_impedanceTest()
{
     double x_tmp = 0.0;
    double r_tmp = 0.0;
