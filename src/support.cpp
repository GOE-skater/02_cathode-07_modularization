...
//**                                                             **
//*****************************************************************
double func_Te(std::vector<double> value,double Te_tmp,double dTe_tmp)
{
...
//**                                                             **
//*****************************************************************
double func_dTe(std::vector<double> value,double Te_tmp,double dTe_tmp)
{
    int iL = int(Te_tmp/dTe_tmp);
    int iR = int(Te_tmp/dTe_tmp)+1;
...
//**                                                             **
//*****************************************************************
double func_Ei_old(std::vector<double> value,double Ei_tmp,double dEi_tmp)
{
...
//**                                                             **
//*****************************************************************
double func_Ei(std::vector<double> value,double Ei_tmp,double dEi_tmp)
{
    int iL = int(Ei_tmp/dEi_tmp);
    int iR = int(Ei_tmp/dEi_tmp)+1;
    double Ei_L = iL*dEi_tmp;
...
//**                                                             **
//*****************************************************************
void plotHistory(FILE* gnuplot_name,std::vector<std::vector<double> > value,std::vector<int> itime_history, int nGnuMaxTimeRange)
{
...
//*****************************************************************
//空間再構築
void reconst0(std::vector<std::vector<double> > value
    ...
    for (int i = 1;i<=ni+1;i++){ 
        for (int j= 1;j<=nj;j++){
            ...
            //左右補完値を計算
            value_Lx[i][j] = value[i-1][j]+d_Lx;
            value_Rx[i][j] = value[i][j]-d_Rx;
        }
    }
    ...
    for (int i = 1;i<=ni;i++){ 
        for (int j= 1;j<=nj+1;j++){
            ...
            //左右補完値を計算
            value_Lr[i][j] = value[i][j-1]+d_Lr;
            value_Rr[i][j] = value[i][j]-d_Rr;
        }
    }
